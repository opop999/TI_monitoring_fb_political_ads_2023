...
summary_dataset <- readRDS(file = file.path(params$input_dir, "summary_tables", "merged_summary.rds"))
time_dataset <- readRDS(file = file.path(params$input_dir, "summary_tables", "time_summary.rds"))
regional_spenders <- readRDS(file = file.path(params$input_dir, "summary_tables", "regional_spenders.rds"))
...
# saveWidget(plot_total_ads, file = paste0(params$output_dir, "/plot_total_ads.html"))
```
...
# saveWidget(plot_total_spending, file = paste0(params$output_dir, "/plot_total_spending.html"))
```
...
# saveWidget(plot_ad_length, file = paste0(params$output_dir, "/plot_ad_length.html"))
```
...
# saveWidget(plot_ad_runtime, file = paste0(params$output_dir, "/plot_ad_runtime.html"))
```
...
# saveWidget(plot_ad_impressions, file = paste0(params$output_dir, "/plot_ad_impressions.html"))
```
...
# saveWidget(plot_ad_audience, file = paste0(params$output_dir, "/plot_ad_audience.html"))
```
...
# saveWidget(plot_spend_over_time, file = paste0(params$output_dir, "/plot_spend_over_time.html"))
```
...
# saveWidget(plot_spend_weekly, file = paste0(params$output_dir, "/plot_spend_weekly.html"))
```
...
# saveWidget(plot_gender, file = paste0(params$output_dir, "/plot_gender.html"))
```
...
# saveWidget(plot_age, file = paste0(params$output_dir, "/plot_age.html"))
```
...
# saveWidget(plot_region, file = paste0(params$output_dir, "/plot_region.html"))
```
...
# saveWidget(plot_top_spenders_by_region, file = paste0(params$output_dir, "/plot_top_spenders_by_region.html"))
```
