...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      ...
      - {title: "Candidates", icon: "ion-ios-people", href: "./index_candidates.html"}
...
params:
  ...
  plots_static_dir: "static_duelists"
  plots_interactive_dir: "interactive_duelists"
...
# Get election duelists ids for filtering
duelists_id <- readRDS(file.path(params$numeric_id_dir, "numeric_ids_duelists.rds"))

# Import datasets created in the previous script
summary_dataset <- readRDS(file.path(params$data_dir, "summary_tables", "merged_summary.rds")) %>% filter(page_id %in% duelists_id)
time_dataset <- readRDS(file.path(params$data_dir, "summary_tables", "time_summary.rds")) %>% filter(page_id %in% duelists_id)
regional_spenders <- readRDS(file.path(params$data_dir, "summary_tables", "regional_spenders.rds")) %>% filter(page_id %in% duelists_id)
