...
function top_ads_scrape(name, id, numbering, date_range) {
...
top_ads_scrape(name = "a > div:nth-child(2) > span > div", // Div element which wraps the text in the first column of the table 
...
// Optional: automatic click to go to the next page
