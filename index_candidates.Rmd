...
output: 
  flexdashboard::flex_dashboard:
    ...
    navbar:
      - {title: "All", icon: "ion-earth", href: "./index_all.html"}            
      - {title: "Duelists", icon: "ion-person-stalker", href: "./index.html"}      
...
candidates_id <- readRDS(file.path(params$numeric_id_dir, "numeric_ids_candidates.rds"))
...
```{r include=FALSE}
plot_name <- "gender"
x_lab <- "Proportion of ads displayed to male audience"
y_lab <- element_blank()
title_lab <- paste(
  "Gender of audience of presidential candidates since",
  format(start_date, "%d.%m.%Y")
)
```
